...
# Added 16.09.2026 (M-Cycle iOS/macOS app icon parity - the app's own
# Assets.xcassets/buttons/ set includes a diaphragm icon that had no
# matching backend option here until now).
CONTRACEPTION_METHOD_DIAPHRAGM = "diaphragm"
...
CONTRACEPTION_METHODS = [
    ...
    CONTRACEPTION_METHOD_DIAPHRAGM,
